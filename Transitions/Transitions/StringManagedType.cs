...
namespace Transitions
{
    ...
    /// </summary>
    internal class StringManagedType : ManagedType<string>
    {
        ...
        /// </summary>
        public override string Copy(string o)
        {
            return o == null ? null : new string(o.ToCharArray());
        }

        /// <summary>
        /// Returns an "interpolated" string.
        /// </summary>
        public override string GetIntermediateValue(string start, string end, double dPercentage)
        {
            var strStart = start;
            var strEnd = end;
